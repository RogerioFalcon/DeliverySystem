<?php if( isset($_SESSION['restaurant_id']) && $_SESSION['user_type'] == "hotel" ){ ?>
		...
		?>
			...
			<script>
				function showDetails(orderID)
				{
					...
					xmlhttp.open("GET","hotel_order_details_ajax.php?orderID="+orderID+"&uid="+<?php echo $_SESSION['restaurant_id'];?>,true);
					xmlhttp.send();
					//alert(str1);
				}

	...
	<link rel="stylesheet" type="text/css" href="frontend_public/assets-minified/css/menu-style.css?1522155548" />
...
if( isset($_SESSION['sessionTokon']))
{
	...
	if(isset($_GET['p']) && isset($_GET['add'])) {
		if($_GET['p']=="manage_menu" && $_GET['add']=="menu") {
			...
			$name = htmlspecialchars(RemoveSpecialChar($_POST['menu_name']), ENT_QUOTES);
		...
		if($_GET['add']=="menuitem") {
			...
			$name = htmlspecialchars(RemoveSpecialChar($_POST['menu_name']), ENT_QUOTES);
			$description = htmlspecialchars(RemoveSpecialChar($_POST['menu_dsc']), ENT_QUOTES);
		...
		if($_GET['add'] == "menuextrasection") {
		    ...
		    $user_id = $userid;
			$name = htmlspecialchars(RemoveSpecialChar($_POST['sec_name']), ENT_QUOTES);
    ...
    <li>
      ...
      <ul class="menuextrasection_ul">
        ...
        <li>
          ...
          <p style="text-align: right; margin-bottom: 21px;">
				<?php
